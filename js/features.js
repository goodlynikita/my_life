...
var Features = (() => {
  ...
  const REGISTRY = [
    ...
    {
      id: 'aurora_slides',        type: 'feature',
      title: '🌌 Aurora на слайдах',
      desc: 'Анимированные переливающиеся облака на главном экране',
      section: 'Дизайн', color: '#818CF8', date: 'сен 2026',
    },
    {
      id: 'colored_headers',      type: 'feature',
      title: '🎨 Цветные шапки разделов',
      desc: 'Тренировки синие, Привычки зелёные, Цели пурпурные — единый размер везде',
      section: 'Дизайн', color: '#818CF8', date: 'сен 2026',
    },
    {
      id: 'registration',         type: 'feature',
      title: '👤 Регистрация пользователей',
      desc: 'На экране входа — вкладка "Регистрация" для создания нового аккаунта',
      section: 'Общее', color: '#34D399', date: 'сен 2026',
    },
    {
      id: 'training_1rm_full',    type: 'feature',
      title: '💪 Калькулятор 1RM с анимацией',
      desc: 'Зоны нагрузки с анимированным появлением, результат не слетает минуту',
      section: 'Тренировки', color: '#F87171', date: 'сен 2026',
    },
  ];
