...
const GOALS_SEASONS = [
  { key: 'all',      label: 'Всё',     color: '#9333EA', bg: '#F5F3FF' },
  { key: 'spring',   label: 'Весна',   color: '#0EA5E9', bg: '#E0F7FF', end: new Date(2026,4,31) },
  { key: 'summer',   label: 'Лето',    color: '#8B5CF6', bg: '#F5F3FF', end: new Date(2026,7,31) },
  { key: 'autumn',   label: 'Осень',   color: '#BE185D', bg: '#FFF1F5', end: new Date(2026,10,30) },
  { key: 'december', label: 'Декабрь', color: '#0369A1', bg: '#E0F7FF', end: new Date(2026,11,31) },
];
...
function goalsMonthsLeft(season) {
  ...
  const now = new Date();
  return Math.max(1, (s.end.getFullYear()-now.getFullYear())*12 + s.end.getMonth()-now.getMonth()+1);
}
...
window.Screens.goals = function(mount) {
  ...
  function render() {
    ...
    if (activeSeason==='all') {
      ...
      heroHtml = `
        <div class="goals-hero-season" style="background:${bg};border-color:${color}33;">
        ...
        <div class="goals-hero-season" style="background:${bg};border-color:${color}33;">
          <div class="goals-hero-season-row">
            <div>
              ...
              <div class="goals-hero-season-amount" style="color:#111;">${goalsFmt(totalAmt)}</div>
            </div>
          ...
          <div class="goals-season-stats">
            <div class="goals-season-stat">
              ...
              <div class="goals-sstat-val">${goalsFmt(remainAmt)}</div>
            </div>
            <div class="goals-season-stat">
