...
window.Screens.goals = function(mount) {
  ...
  mount.innerHTML = `
    <div class="goals-screen" style="min-height:100vh;background:#0F1117;">
      ...
      <button id="goals-new" style="position:fixed;bottom:80px;right:20px;z-index:20;background:#F2A93B;color:#000;border:none;border-radius:50%;width:52px;height:52px;font-size:26px;cursor:pointer;box-shadow:0 4px 16px rgba(242,169,59,0.45);font-weight:700;">+</button>
    </div>`;
