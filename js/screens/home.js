...
window.Screens.home = function(mount) {
  ...
  mount.innerHTML = '<div class="home2-screen">'
    ...
    + '<button class="home2-tile home2-tile-goals" data-route="/goals"><div class="home2-tile-content"><div class="home2-tile-top"><div class="home2-tile-index">04</div></div><div class="home2-tile-name">Цели</div><div class="home2-tile-rule"></div><div class="home2-tile-data"><strong>'+goalsPct+'%</strong> выполнено</div></div><div class="home2-goals-radar"><span></span><i></i></div><div class="home2-tile-arrow">→</div></button>'
    + '</div>'
