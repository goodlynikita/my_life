...
window.Screens.home = function(mount) {
  ...
  mount.innerHTML = '<div class="home2-screen">'
    ...
    + '<button class="home2-tile home2-tile-training" data-route="/training"><div class="home2-tile-content"><div class="home2-tile-top"><div class="home2-tile-index">01</div></div><div class="home2-tile-name">Тренировки</div><div class="home2-tile-rule"></div><div class="home2-tile-data">'+((todayGroups.length?todayGroups.join(' · '):'')+(todayExerciseName?(todayGroups.length?' · ':'')+todayExerciseName:'')||'Не задано')+'</div></div><div class="home2-tile-arrow">→</div></button>'
    + '<button class="home2-tile home2-tile-habits" data-route="/habits"><div class="home2-tile-content"><div class="home2-tile-top"><div class="home2-tile-index">02</div></div><div class="home2-tile-name">Привычки</div><div class="home2-tile-rule"></div><div class="home2-tile-data"><strong>'+todayDone+'/'+habList.length+'</strong> сегодня</div><div class="h2-dots">'+habitDotsHtml+'</div></div><div class="home2-tile-arrow">→</div></button>'
    + '<button class="home2-tile home2-tile-finance" data-route="/finance"><div class="home2-tile-content"><div class="home2-tile-top"><div class="home2-tile-index">03</div></div><div class="home2-tile-name">Финансы</div><div class="home2-tile-rule"></div><div class="home2-tile-data">'+(monthIncome>0?fmt(monthIncome):'Добавить доход')+' <span class="tile-data-month">/ '+MONTHS[now.getMonth()]+'</span></div></div><svg class="home2-finance-chart" viewBox="0 0 300 120" preserveAspectRatio="none" aria-hidden="true"><path d="M5 100 C35 82 48 90 70 78 S105 85 125 62 S158 70 180 48 S214 55 232 42 S265 48 295 10" fill="none" stroke="currentColor" stroke-width="2.5"/><circle cx="295" cy="10" r="5" fill="currentColor"/></svg><div class="home2-tile-arrow">→</div></button>'
    + '<button class="home2-tile home2-tile-goals" data-route="/goals"><div class="home2-tile-content"><div class="home2-tile-top"><div class="home2-tile-index">04</div></div><div class="home2-tile-name">Цели</div><div class="home2-tile-rule"></div><div class="home2-tile-data"><strong>'+goalsPct+'%</strong> выполнено</div></div>'
    + '<div class="home2-target-art" aria-hidden="true"><svg viewBox="0 0 420 220" preserveAspectRatio="none">'
    + '<circle cx="255" cy="110" r="92" class="target-ring ring-1"/><circle cx="255" cy="110" r="63" class="target-ring ring-2"/><circle cx="255" cy="110" r="34" class="target-ring ring-3"/>'
    + '<path d="M92 175 C128 165 150 145 173 142 S210 120 226 112 S246 104 255 110 S286 91 318 54" class="target-route"/>'
    + '<circle cx="255" cy="110" r="5" class="target-dot target-start"/><circle cx="318" cy="54" r="7" class="target-dot target-end"/>'
    + '<circle cx="255" cy="110" r="11" class="target-core"/></svg></div>'
    + '<div class="home2-tile-arrow">→</div></button>'
    + '</div>'
